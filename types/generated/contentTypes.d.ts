...
export interface ApiArticuloArticulo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    instalacion: Schema.Attribute.Blocks &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    precio_por_dia: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    requiereCapacitacion: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<false>;
    requiereInstalacion: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiFacturaFactura extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    archivoPDF: Schema.Attribute.Media<'files'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::factura.factura'
    >;
    metodoPago: Schema.Attribute.Enumeration<['PUE', 'PPD']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
      ...
      Schema.Attribute.DefaultTo<'PUE'>;
...
export interface ApiInventarioInventario extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    identificador: Schema.Attribute.UID &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiOrdenOrden extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    descuentos: Schema.Attribute.Decimal &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
